...
public class ProductDAO {
  ...
  public String pageNumber(int tpage, String name) {
    ...
    if (start_page > view_rows) {
      str += "<a href='jspshopServlet?command=admin_product_list&tpage=1&key=" + name + "'>&lt;&lt;</a>&nbsp;&nbsp;";
      str +="<a href='jspshopServlet?command=admin_product_list&tpage="+ (start_page - 1) + "&key=<%=product_name%>'>&lt;</a>&nbsp;&nbsp;";
    }
    ...
    for (int i = start_page; i <= end_page; i++) {
      if (i == tpage) {
        ...
        str += "<a href='jspshopServlet?command=admin_product_list&tpage="+ i + "&key=" + name + "'>[" + i + "]</a>&nbsp;&nbsp;";
      }
    }
    
    //총 페이지가 end_page보다 클 경우
    if (page_count > end_page) {
      str += "<a href='jspshopServlet?command=admin_product_list&tpage="+ (end_page + 1) + "&key=" + name + "'> &gt; </a>&nbsp;&nbsp;";
      str += "<a href='jspshopServlet?command=admin_product_list&tpage="+ page_count + "&key=" + name + "'> &gt; &gt; </a>&nbsp;&nbsp;";
    }
    return str;
  }
